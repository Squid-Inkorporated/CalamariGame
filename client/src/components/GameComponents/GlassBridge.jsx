        ...
        <div>
          ...
          <div className="row justify-content-center flex-lg-col flex-row position-relative">
            ...
            <div className="d-flex justify-content-center flex-lg-row flex-column col">
              ...
              {/* button 5 */}
              <div>
                <button id="5" onClick={handleClick} className="bridgeTile ">
                  {clickMe6 && <h5>Click one Of Us</h5>}
                  {picked6 && (
                    <i class="display-1 fa-solid fa-skull-crossbones"></i>
                  )}
                </button>
              </div>
              {/* button 7 */}
            ...
            <div className="d-flex justify-content-center flex-lg-row flex-column col">
              <div>
                <button id="2" onClick={handleClick} className="bridgeTile">
              ...
              {/* button 4 */}
              <div>
                <button id="4" onClick={handleClick} className="bridgeTile">
